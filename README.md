...
* Recovery and death rates were successfully calculated
* Clear trends were observed during peak months (March–April)
* Visualizations made complex data easy to understand
* High confirmed cases do not always imply high death rates
...
* Debugging Pandas and Python errors
